...
public class FacultyTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("f1 and f3 store the same contents: " + f1.getDescription().equals(f3.getDescription()));
		
		Faculty f4 = f1; // aliasing: f1 and f4 are two different names storing the same address (for the same object).
		...
		System.out.println("f1 and f4 store the same contents: " + f1.getDescription().equals(f4.getDescription()));
		
		// Because f1 and f4 point to the same object.
		// Using any of the names (f1 or f4) as the context object for a mutator method call will have the effect visible to all the names
		f1.setName("Heeyon");

...
public class CourseRecordTester {
	...
	public static void main(String[] args) {
		...
		System.out.println(cr1.getDescription()); // what's the value of cr1 instructor? --> null
		cr1.setTitle("EECS 2030");
		cr1.setMarks(73);
		cr1.setInstructor(f1);
		System.out.println(cr1.getDescription());
		
		CourseRecord cr2 = new CourseRecord("EECS 1021"); // Version 2
		System.out.println(cr2.getDescription());
		
		CourseRecord cr3 = new CourseRecord("EECS 3311", 68); // Version 3

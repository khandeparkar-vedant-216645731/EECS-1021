...
public class IntegerArray2 {
	...
	public static void main(String[] args) {
		...
		// 2. Use separate assignments, each or which initializing an element in the array (at a particular index)
		
		// Create an array of size 10 where each slot stores the default value for the int type (i.e., 0)
		...
		// Print out each element in the array, from largest to smallest
